  ...
  return (
    ...
    >
      ...
      <section>
        ...
        <p>
          В проектах для визуализации данных используем ECharts: он гибкий и хорошо настраивается под дизайн-систему
          Admiral.
        </p>
        ...
        <ul>
          ...
          <li>Сложные градиенты — выбирайте простые заливки с прозрачностью.</li>
        ...
        <p>
          Держите визуализацию минималистичной: без лишних скруглений и 3D. Работайте цветами, текстами и структурой,
          чтобы графики оставались читаемыми и соответствовали дизайн-системе.
        </p>
      </section>
      <p>
        Как стилизовать ECharts под тему Admiral DS и подключать чарты двумя способами: нативно через CustomChart и
        через обертку ReactChart (echarts-for-react).
      </p>

      <section>
        <h2>Базовые стили от темы</h2>
        <p>
          Получите тему (<code>useTheme() || LIGHT_THEME</code>) и задайте глобальный textStyle. Пример ниже использует
          бар-чарт из SeriesLayoutByColumnOrRow:
        </p>
        <pre
          style={{
            padding: 12,
...
const option: EChartsOption = {
  ...
  series: [
    ...
    // ...
        ...
        <p>Локально переопределяйте только отличия (например, fontWeight для title), без дублирования fontFamily.</p>
      </section>

      <section>
        <h2>Вариант 1. Нативный ECharts (customCharts)</h2>
        <CustomChart option={option} size={{ width: 520, height: 360 }} aria-label="Пример нативного чарта" />
        <ul>
      ...
      <section>
        ...
        <ul>
          ...
          <li>Нужно быстро и просто — ReactChart (обертка echarts-for-react).</li>
        </ul>
      </section>
      ...
      <section>
        ...
        <ul>
          <li>
            CustomChart (нативный) — если нужен полный контроль init/setOption, ручное управление жизненным циклом и
            тонкие настройки.
          </li>
          <li>
            ReactChart — если важен быстрый старт, меньше кода, автоматическое обновление и стандартные сценарии с
            событиями.
          </li>
        </ul>
      </section>
